...
if __name__ == "__main__":
    connection(host='localhost', port=27017, database=db, colecao="clientes", dados_a_inserir=clientes)
    connection(host='localhost', port=27017, database=db, colecao="pedidos", dados_a_inserir=pedido)